...
> **Title:** Deep Spatial Guidance Framework for Socially Compliant Robot Cruising in Dynamic Scenarios  
...
* **`code/`** The complete source code for the project. This directory contains:
    * **Core Algorithms:** Implementation of the proposed **DSG-RRT*** planner and the comparative baseline algorithms (Standard RRT*, Informed RRT*, Neural RRT*), alongside the PointNet++ based deep spatial guidance network.
...
The scale has been rigorously tested in our study by **the participating volunteers** across two dynamic experimental scenarios. The statistical analysis confirms its suitability for **evaluating social compliance**:
