                ...
                if (flag==1):
                    ...
                    if len(tsp_usestoreold) >= 3:
                        ...
                        if closest_index != -1 and closest_index != 2:
                            ...
                            tsp_usestoreold[1], tsp_usestoreold[closest_index] = tsp_usestoreold[closest_index], tsp_usestoreold[1]
...
if __name__ == '__main__':
    ...
    '''
    cirobstacle1 = [[0.1,-0.5,0.15],[1.80, -1.2, 0.15]]
    recobstacle1 = [[0.0, 1.25, 0.25, 0.25],[-2.40,-0.60,0.35,0.35]]
    '''

    cirobstacle = [[0.1, -0.5, 0.36], [1.80, -1.20, 0.3]]
    recobstacle = [[-0.1, 1.15, 0.45, 0.45], [-2.45, -0.65, 0.45, 0.45]]
