...
static_person1 = pd.read_csv(r"D:\DSGRRT\simulation\dsgrrt\scenario_2\dsgrrt_static_person.csv", header=0)
static_person = np.array(static_person1.values)

print(static_person)

cirobstacle = pd.read_csv(r"D:\DSGRRT\simulation\dsgrrt\scenario_2\dsgrrt_cirobstacle.csv", header=0)
cirobstacle1 = np.array(cirobstacle.values)
print(cirobstacle1)

recobstacle = pd.read_csv(r"D:\DSGRRT\simulation\dsgrrt\scenario_2\dsgrrt_recobstacle.csv", header=0)
...
data1.to_csv("D:/DSGRRT/simulation/dsgrrt/scenario_2/dsgrrt_newpath_1.csv", index=False)
