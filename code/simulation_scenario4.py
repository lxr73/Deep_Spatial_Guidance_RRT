...
#scenario 4 setting
robotCon = np.array([10.0,8.0,-pi/6])

static_person1 = pd.read_csv(r"D:\DSGRRT\simulation\dsgrrt\scenario_4\dsgrrt_static_person.csv", header=0)
static_person = np.array(static_person1.values)

print(static_person)

cirobstacle = pd.read_csv(r"D:\DSGRRT\simulation\dsgrrt\scenario_4\dsgrrt_cirobstacle.csv", header=0)
cirobstacle1 = np.array(cirobstacle.values)
print(cirobstacle1)

recobstacle = pd.read_csv(r"D:\DSGRRT\simulation\dsgrrt\scenario_4\dsgrrt_recobstacle.csv", header=0)
...
static_person1 = pd.read_csv(r"D:\DSGRRT\simulation\dsgrrt\scenario_4\dsgrrt_static_person1.csv", header=0)
static_person = np.array(static_person1.values)
...
data1.to_csv("D:/DSGRRT/simulation/dsgrrt/scenario_4/dsgrrt_newpath_1a.csv", index=False)

data1 = pd.DataFrame(combined_data2, columns=['x', 'y', 'theta'])

data1.to_csv("D:/DSGRRT/simulation/dsgrrt/scenario_4/dsgrrt_newpath_1.csv", index=False)
